...
牌譜の取得・保存・匿名化手順はADR-0009で一度改定し、その後[ADR-0010](0010-mahjong-soul-record-conformance.md)で再改定する。現在はuserがproject外で取得したraw牌譜を、変換用app crateによるCI用最小fixtureとCI外full-record testの二段階で利用する。
