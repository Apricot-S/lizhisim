...
- [2. 卓内シミュレーション](#2-卓内シミュレーション)
- [3. 手牌評価と点数計算](#3-手牌評価と点数計算)
- [4. ルール設定とプリセット](#4-ルール設定とプリセット)
- [5. 半荘・対局](#5-半荘対局)
- [6. AI 意思決定と観測](#6-ai-意思決定と観測)
- [7. キュー、バッチ、スケジューリング](#7-キューバッチスケジューリング)
- [8. 大会・段位・リーグ](#8-大会段位リーグ)
- [9. 記録・再生・データ出力](#9-記録再生データ出力)
- [10. 非機能要求](#10-非機能要求)
- [11. 制約](#11-制約)
- [12. 未決事項](#12-未決事項)
...
実装開始前または該当milestone前に決める事項の状態と必要時期は、[ロードマップの未決事項](roadmap.md#現在の-blockingopen-decisions)を正とする。決定時は対応する要求・設計とADRを更新する。
